...
export class InteractionOverlay {
  ...
  dispose(): void { if (this.#frame !== undefined) this.scheduler.cancel(this.#frame); this.#frame = undefined; this.#preview = undefined; this.#committedSelection = null; if (this.#element) this.#element.replaceChildren(); this.#element = undefined; }
